...
var _ConferenceIntroduction = require('./components/ConferenceIntroduction.vue');

var _ConferenceIntroduction2 = _interopRequireDefault(_ConferenceIntroduction);

var _User = require('./components/User.vue');

var _User2 = _interopRequireDefault(_User);

var _UserSettings = require('./components/UserSettings.vue');
...
if (document.getElementById("confomo-app")) {
    new Vue({
        ...
        components: {
            ...
            ConferenceIntroduction: _ConferenceIntroduction2.default,
            User: _User2.default,
...
},{"./components/Conference.vue":17,"./components/ConferenceIntroduction.vue":18,"./components/Dashboard.vue":20,"./components/FormErrors.vue":22,"./components/User.vue":25,"./components/UserSettings.vue":26,"./core/dependencies":27}],17:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-691f613a", module.exports)
  } else {
    hotAPI.update("_v-691f613a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    methods: {
        addIntroduction: function addIntroduction() {
            var _this = this;

            if (this.addIntroductionForm.username == '') {
                this.addIntroductionForm.errors = ['You need to actually type something for the name.'];
            ...
            this.$http.post('/api/conferences/' + Confomo.conferenceSlug + '/introduction', this.addIntroductionForm).then(function (friend) {
...
exports.default = {
    ...
    methods: {
        getUserConferences: function getUserConferences() {
            var _this = this;

            this.$http.get('/api/users/' + this.twitterNickname + '/conferences').then(function (conferences) {
                if ('future' in conferences.data) {
                    _this.futureList = conferences.data.future;
                }
                if ('past' in conferences.data) {
                    _this.pastList = conferences.data.past;
                }
            }, function (response) {});
        },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3d286044", module.exports)
  } else {
    hotAPI.update("_v-3d286044", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
    ...
    methods: {
        ...
        deleteConference: function deleteConference(conference, $e) {
            ...
            swal({
                ...
                vm.$http.delete('/api/conferences/' + conference.slug).then(function () {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-19d4b803", module.exports)
  } else {
    hotAPI.update("_v-19d4b803", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../utils/EventListener.js":28,"vue":14,"vue-hot-reload-api":12,"vueify/lib/insert-css":15}],22:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"alert alert-danger\" v-show=\"form.errors.length > 0\">\n    <strong>Whoops!</strong> Looks like something went wrong!\n\n    <br><br>\n\n    <ul>\n        <li v-for=\"error in form.errors\">\n            {{ error }}\n        </li>\n    </ul>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-a2d303d4", module.exports)
  } else {
    hotAPI.update("_v-a2d303d4", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    methods: {
        getAllFriends: function getAllFriends() {
            ...
            this.$http.get('/api/conferences/' + this.conferenceSlug + '/' + this.key).then(function (friends) {
                _this.list = friends.data;
            });
        },
        ...
        addFriend: function addFriend() {
            ...
            this.$http.post('/api/conferences/' + this.conferenceSlug + '/' + this.key, this.addFriendForm).then(function (friend) {
        ...
        deleteFriend: function deleteFriend(friend) {
            ...
            swal({
                ...
                vm.$http.delete('/api/conferences/' + vm.conferenceSlug + '/' + vm.key + '/' + friend.id).then(function () {
                    vm.list.$remove(friend);
                });
            });
        },

        markFriendMet: function markFriendMet(friend) {
            this.toggleFriendMet(friend, true);
        },

        markFriendNotMet: function markFriendNotMet(friend) {
            this.toggleFriendMet(friend, false);
        },

        toggleFriendMet: function toggleFriendMet(friend, met) {
            this.$http.patch('/api/conferences/' + this.conferenceSlug + '/' + this.key + '/' + friend.id, { met: met }).then(function () {
                friend.met = met;
            });
        }
    }
...
exports.default = {
    ...
    methods: {
        getUserSettings: function getUserSettings() {
            ...
            this.$http.get('/api/settings').then(function (settings) {
                console.log(settings);
                _this.userSettingsForm.userIsSearchable = settings.data.userIsSearchable;
                _this.userSettingsForm.conferenceListIsPublic = settings.data.conferenceListIsPublic;
            });
        },
        ...
        submitSettings: function submitSettings() {
            ...
            this.$http.post('/api/settings', this.userSettingsForm).then(function (settings) {
                _this2.userSettingsForm.submitting = false;
            }, function (response) {
                _this2.setErrorsOnForm(_this2.userSettingsForm, response.data);
                _this2.userSettingsForm.submitting = false;
            });
        }
    }
...
var _ConferencesList = require('./ConferencesList.vue');

var _ConferencesList2 = _interopRequireDefault(_ConferencesList);
...
exports.default = {
    data: function data() {
        return {
            currentUserId: Confomo.userId,
            twitterNickname: Confomo.twitter_nickname,
    ...
    components: { ConferencesList: _ConferencesList2.default }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"user\">\n\t<conferences-list :future-list=\"futureList\" :past-list=\"pastList\" :twitter-nickname=\"twitterNickname\"></conferences-list>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7506945c", module.exports)
  } else {
    hotAPI.update("_v-7506945c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./ConferencesList.vue":19,"vue":14,"vue-hot-reload-api":12}],26:[function(require,module,exports){
'use strict';
...
var _SettingList = require('./SettingList.vue');
...
exports.default = {
    ...
    components: { SettingList: _SettingList2.default }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e46fbad6", module.exports)
  } else {
    hotAPI.update("_v-e46fbad6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./SettingList.vue":24,"vue":14,"vue-hot-reload-api":12}],27:[function(require,module,exports){
'use strict';
...
},{"sweetalert/lib/sweetalert":10,"underscore":11,"vue":14,"vue-resource":13}],28:[function(require,module,exports){
'use strict';
