...
},{"./components/Conference.vue":41,"./components/Dashboard.vue":42,"./components/FormErrors.vue":43,"./core/dependencies":45}],41:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/michael/Development/confomo.internal/resources/assets/js/components/Conference.vue"
  if (!module.hot.data) {
...
},{"./FriendsList.vue":44,"vue":39,"vue-hot-reload-api":14}],42:[function(require,module,exports){
'use strict';
    ...
    methods: {
        ...
        deleteConference: function deleteConference(conference, $e) {
            ...
            swal({
                ...
                vm.$http.delete('/api/conferences/' + conference.id).then(function () {
...
},{"vue":39,"vue-hot-reload-api":14}],43:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/michael/Development/confomo.internal/resources/assets/js/components/FormErrors.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":39,"vue-hot-reload-api":14}],44:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        getAllFriends: function getAllFriends() {
            ...
            this.$http.get('/api/conferences/' + this.conferenceId + '/' + this.key).then(function (friends) {
        ...
        addFriend: function addFriend() {
            ...
            this.$http.post('/api/conferences/' + this.conferenceId + '/' + this.key, this.addFriendForm).then(function (friend) {
...
},{"vue":39,"vue-hot-reload-api":14}],45:[function(require,module,exports){
'use strict';
...
},{"bootstrap-sass/assets/javascripts/bootstrap":1,"jquery":2,"sweetalert/lib/sweetalert":12,"underscore":13,"vue":39,"vue-resource":28}]},{},[40]);
